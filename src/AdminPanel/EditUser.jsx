  ...
  const getUserData = async () => {
    try {
      const response = await axios.get(
        `https://localhost:44392/api/Registration/GetUser/${intRegistrationId}`
      );
        ...
        <Card>
          <CardBody>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              <Input label="name" type="text" name="strName" value={userData.strName} onChange={handleInputChange} placeholder="Name" />
              <Input label="Username" type="text" name="strUsername" value={userData.strUsername} onChange={handleInputChange} placeholder="Username" />
              <Input label="Email" type="text" name="strEmail" value={userData.strEmail} onChange={handleInputChange} placeholder="Email" />
