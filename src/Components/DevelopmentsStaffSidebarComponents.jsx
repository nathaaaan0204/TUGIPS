...
export const DevelopmentsStaffSidebarComponents = () => {
  ...
  const navList = (
    <List>
      ...
      <Link to="/DevelopmentsStaffDashboard">
        <ListItem>
          <ListItemPrefix>
      ...
      >
        ...
        <AccordionBody className="py-1">
          <List className="p-0">
            <Link to="/DevelopmentsStaffViewArticles">
              <ListItem>
                <ListItemPrefix>
            ...
            <Link to="/DevelopmentsStaffAddArticles">
              <ListItem>
                <ListItemPrefix>
                  <ChevronRightIcon strokeWidth={3} className="h-3 w-5" />
                </ListItemPrefix>
