...
export const Opinion = ({ articles }) => {
  // Filter the articles array to get only articles with the "Sports" category
  const opinionArticles = articlesData.filter((article) => article.category === 'Opinion');

  return (
    <Fragment>
      <NavigationBar/>
      <div className="bg-green text-white pt-40 pb-20 text-center">
      <Typography className="text-6xl font-medium">Opinion</Typography>
    </div>
